...
\end{figure}
\newline
\paragraph{H4. Consistency and standards - Score 2}	In general, there is a bit of consistency between pages and some standards are respected, but there are also many problems.
